...
public class LoanRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.loan.request.api.loan_request_api.topology.LoanRequest.Builder newBuilder() {
    return new com.loan.request.api.loan_request_api.topology.LoanRequest.Builder();
  }
   ...
   * @return A new LoanRequest RecordBuilder
   */
  public static com.loan.request.api.loan_request_api.topology.LoanRequest.Builder newBuilder(com.loan.request.api.loan_request_api.topology.LoanRequest.Builder other) {
    if (other == null) {
      return new com.loan.request.api.loan_request_api.topology.LoanRequest.Builder();
    } else {
      return new com.loan.request.api.loan_request_api.topology.LoanRequest.Builder(other);
    }
  }
   ...
   * @return A new LoanRequest RecordBuilder
   */
  public static com.loan.request.api.loan_request_api.topology.LoanRequest.Builder newBuilder(com.loan.request.api.loan_request_api.topology.LoanRequest other) {
    if (other == null) {
      return new com.loan.request.api.loan_request_api.topology.LoanRequest.Builder();
    } else {
      return new com.loan.request.api.loan_request_api.topology.LoanRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LoanRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.loan.request.api.loan_request_api.topology.LoanRequest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.loan.request.api.loan_request_api.topology.LoanRequest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.requestId)) {
        this.requestId = data().deepCopy(fields()[0].schema(), other.requestId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder setRequestId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder clearRequestId() {
      requestId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder setAccount(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder clearAccount() {
      account = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder setAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder clearAmount() {
      amount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.LoanRequest.Builder clearTimestamp() {
