...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3330946122094019909L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Account\",\"namespace\":\"com.loan.request.api.loan_request_api.topology\",\"fields\":[{\"name\":\"account\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.loan.request.api.loan_request_api.topology.Account.Builder newBuilder() {
    return new com.loan.request.api.loan_request_api.topology.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static com.loan.request.api.loan_request_api.topology.Account.Builder newBuilder(com.loan.request.api.loan_request_api.topology.Account.Builder other) {
    if (other == null) {
      return new com.loan.request.api.loan_request_api.topology.Account.Builder();
    } else {
      return new com.loan.request.api.loan_request_api.topology.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static com.loan.request.api.loan_request_api.topology.Account.Builder newBuilder(com.loan.request.api.loan_request_api.topology.Account other) {
    if (other == null) {
      return new com.loan.request.api.loan_request_api.topology.Account.Builder();
    } else {
      return new com.loan.request.api.loan_request_api.topology.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.loan.request.api.loan_request_api.topology.Account.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.loan.request.api.loan_request_api.topology.Account other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.account)) {
        this.account = data().deepCopy(fields()[0].schema(), other.account);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.Account.Builder setAccount(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.loan.request.api.loan_request_api.topology.Account.Builder clearAccount() {
      account = null;
