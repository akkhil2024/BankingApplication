...
public class LoanRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2309798002643840558L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LoanRequest\",\"namespace\":\"com.tolopolgyservice.Tolopolgyservice.topology\",\"fields\":[{\"name\":\"requestId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"account\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":14,\"scale\":2}},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}");
   ...
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder newBuilder() {
    return new com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder();
  }
   ...
   * @return A new LoanRequest RecordBuilder
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder newBuilder(com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder other) {
    if (other == null) {
      return new com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder();
    } else {
      return new com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder(other);
    }
  }
   ...
   * @return A new LoanRequest RecordBuilder
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder newBuilder(com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest other) {
    if (other == null) {
      return new com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder();
    } else {
      return new com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LoanRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.requestId)) {
        this.requestId = data().deepCopy(fields()[0].schema(), other.requestId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder setRequestId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder clearRequestId() {
      requestId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder setAccount(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder clearAccount() {
      account = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder setAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder clearAmount() {
      amount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.LoanRequest.Builder clearTimestamp() {
