...
public class AccountBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8924090688389356508L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AccountBalance\",\"namespace\":\"com.tolopolgyservice.Tolopolgyservice.topology\",\"fields\":[{\"name\":\"account\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":14,\"scale\":2}},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}");
   ...
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder newBuilder() {
    return new com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder();
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder newBuilder(com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder other) {
    if (other == null) {
      return new com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder();
    } else {
      return new com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder(other);
    }
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder newBuilder(com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance other) {
    if (other == null) {
      return new com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder();
    } else {
      return new com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountBalance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.account)) {
        this.account = data().deepCopy(fields()[0].schema(), other.account);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder setAccount(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder clearAccount() {
      account = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder setAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder clearAmount() {
      amount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tolopolgyservice.Tolopolgyservice.topology.AccountBalance.Builder clearTimestamp() {
